var countries=[
  ...
  for(let country of countries){
    ...
    let countryCurrency='na'
    let countryCapital=country.capital;
    if("currencies" in country){
      countryCurrency=country.currencies[0].name;
    }
    // console.log(`name: ${countryName} population: ${population} currency :${countryCurrency} Capital: ${countryCapital}`);
  //  countryArray.push(countryName,population,countryCurrency,countryCapital)
  let countryObj={countryName,population,countryCurrency,countryCapital}
  countryArray.push(countryObj)
  // console.log(country.name);
  // var currChi=countryArray.find(cur=>cur.countryName="China").countryCurrency
 

  // var indiaData=countryArray.find(ind=>ind.countryName=="India")
...
//  countryArray.forEach(data=>console.log(data.countryName))

countryArray.filter(data=>data.population>20000000).map(cntry=>cntry.countryName).forEach(name=>console.log(name))